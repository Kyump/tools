...
- renderInput (**required**): Function used to render elements of the form. It takes an object with 3 props _field_ ([BasicFieldInterface](src/types.js#L6-L14)), its _children_ (?React\$Node[]) and the index of the field in the fields array
